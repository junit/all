...
<mapper namespace="${name}"> 
  <resultMap id="bean" type="com.mokylin.game.server.db.${type}.bean.${name?cap_first}Bean" >
  ...
  <insert id="insert" parameterType="com.mokylin.game.server.db.${type}.bean.${name?cap_first}Bean">
