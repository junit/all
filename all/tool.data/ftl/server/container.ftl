package com.mokylin.game.server.db.config.container;
...
import com.mokylin.game.server.db.config.dao.${name?cap_first}Dao;
import com.mokylin.game.server.db.config.bean.${name?cap_first}Bean;
