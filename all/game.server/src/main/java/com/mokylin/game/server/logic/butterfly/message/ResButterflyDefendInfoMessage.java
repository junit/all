...
import com.mokylin.game.server.logic.butterfly.bean.*;
 ...
 * 地狱蝶抢夺纪录消息
 */
public class ResButterflyDefendInfoMessage extends Message{

	private static Logger log = Logger.getLogger(ResButterflyDefendInfoMessage.class);
